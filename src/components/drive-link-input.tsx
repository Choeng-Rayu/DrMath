...
export function DriveLinkInput({ id, name, defaultValue }: { id: string; name: string; defaultValue?: string }) {
  ...
  return <>
    ...
    {image && <div style={{ display: "grid", gridTemplateColumns: "150px 1fr", gap: ".8rem", alignItems: "center" }}><img src={image.renderUrl} alt="មើលរូបភាព Google Drive ជាមុន" referrerPolicy="no-referrer" style={{ width: 150, height: 95, objectFit: "cover", borderRadius: 8, border: "1px solid #ccd5e5" }} /><p className="success">តំណរូបភាពត្រឹមត្រូវ។ សូមប្រាកដថា Drive កំណត់ជា <strong>Anyone with the link</strong> មុនរក្សាទុក។</p></div>}
  </>;
}
